select
    ...
    cast(tpep_pickup_datetime as timestamp) as pickup_datetime,   -- tpep = Taxicab Passenger Enhancement Program
	...
	0 as ehail_fee, -- yellow taxis do not have e-hail fee
